...
- **Database Creation**: The project starts by creating a database named `pizza_sales`.

```sql
CREATE DATABASE pizza_sales;
```

## Import database through the mysql or mysql workbanch
## or import the tables from csv files
